...
export default function BankPage() {
  ...
  const deleteMutation = useMutation({
    mutationFn: bank.deleteItem,
  });
  const columns: ColumnsType<any> = [
    {
      title: "Ngân hàng",
      dataIndex: "BankName",
      render: (_: any, record: any) => <div>{t(record.BankName)}</div>,
    },
    {
      title: "Số tài khoản ",
      dataIndex: "AccountNo",
      render: (_: any, record: any) => <div>{t(record.AccountNo)}</div>,
    },
