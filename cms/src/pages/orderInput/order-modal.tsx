...
const OrderModal = ({
  ...
  const onFinish = async (values: any) => {
    if (userId && userId) {
      ...
      values.OrderType = OrderType.Input;
      ...
      if (!(editItem && editItem)) {
        ...
        let postTypeId = values.PostTypeId.value;
        values.PostTypeId = postTypeId;
  ...
  useEffect(() => {
    ...
    if (editItem && editItem) {
      ...
      newItem.PostTypeId = posttypes
        ...
        .filter((i: any) => i.value == editItem.Order.PostTypeId)[0];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="mt-3">
          <Card title="Thông tin người giao">
            <Row>
